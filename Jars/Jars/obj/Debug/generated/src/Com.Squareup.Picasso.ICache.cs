...
namespace Com.Squareup.Picasso {
	...
	public partial interface ICache : IJavaObject {
		...
		[Register ("clear", "()V", "GetClearHandler:Com.Squareup.Picasso.ICacheInvoker, Jars")]
		void Clear ();
		...
		[Register ("clearKeyUri", "(Ljava/lang/String;)V", "GetClearKeyUri_Ljava_lang_String_Handler:Com.Squareup.Picasso.ICacheInvoker, Jars")]
		...
		[Register ("get", "(Ljava/lang/String;)Landroid/graphics/Bitmap;", "GetGet_Ljava_lang_String_Handler:Com.Squareup.Picasso.ICacheInvoker, Jars")]
		...
		[Register ("maxSize", "()I", "GetMaxSizeHandler:Com.Squareup.Picasso.ICacheInvoker, Jars")]
		int MaxSize ();
		...
		[Register ("set", "(Ljava/lang/String;Landroid/graphics/Bitmap;)V", "GetSet_Ljava_lang_String_Landroid_graphics_Bitmap_Handler:Com.Squareup.Picasso.ICacheInvoker, Jars")]
		...
		[Register ("size", "()I", "GetSizeHandler:Com.Squareup.Picasso.ICacheInvoker, Jars")]
		int Size ();
