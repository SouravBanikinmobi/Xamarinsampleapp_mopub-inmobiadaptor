...
namespace Com.Squareup.Picasso {
	...
	public partial interface ITransformation : IJavaObject {
		...
		[Register ("key", "()Ljava/lang/String;", "GetKeyHandler:Com.Squareup.Picasso.ITransformationInvoker, Jars")]
		string Key ();
		...
		[Register ("transform", "(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;", "GetTransform_Landroid_graphics_Bitmap_Handler:Com.Squareup.Picasso.ITransformationInvoker, Jars")]
