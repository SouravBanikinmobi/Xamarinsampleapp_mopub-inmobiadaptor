...
namespace Com.Inmobi.Commons.Core.Utilities.Uid {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.inmobi.commons.core.utilities.uid']/class[@name='ImIdShareBroadCastReceiver']"
	[ObsoleteAttribute (@"This class is obsoleted in this android platform")]
	[global::Android.Runtime.Register ("com/inmobi/commons/core/utilities/uid/ImIdShareBroadCastReceiver", DoNotGenerateAcw=true)]
	public partial class ImIdShareBroadCastReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/inmobi/commons/core/utilities/uid/ImIdShareBroadCastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ImIdShareBroadCastReceiver); }
		}

		protected ImIdShareBroadCastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.inmobi.commons.core.utilities.uid']/class[@name='ImIdShareBroadCastReceiver']/constructor[@name='ImIdShareBroadCastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ImIdShareBroadCastReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ImIdShareBroadCastReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Inmobi.Commons.Core.Utilities.Uid.ImIdShareBroadCastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Inmobi.Commons.Core.Utilities.Uid.ImIdShareBroadCastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inmobi.commons.core.utilities.uid']/class[@name='ImIdShareBroadCastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
