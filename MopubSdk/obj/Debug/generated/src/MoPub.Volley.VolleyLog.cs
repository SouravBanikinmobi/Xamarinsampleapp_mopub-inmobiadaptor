			...
			public partial class Marker : global::Java.Lang.Object {
				...
				public long Thread {
					get {
						...
						return JNIEnv.GetLongField (((global::Java.Lang.Object) this).Handle, thread_jfieldId);
					}
					set {
						if (thread_jfieldId == IntPtr.Zero)
							thread_jfieldId = JNIEnv.GetFieldID (class_ref, "thread", "J");
						try {
							JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, thread_jfieldId, value);
						} finally {
						}
					}
				}
					...
					: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
				{
					...
					try {
						...
						if (((object) this).GetType () != typeof (Marker)) {
							SetHandle (
									global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;JJ)V", __args),
									JniHandleOwnership.TransferLocalRef);
							global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;JJ)V", __args);
							return;
						}
						...
						SetHandle (
								...
								JniHandleOwnership.TransferLocalRef);
						JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_lang_String_JJ, __args);
					} finally {
...
#pragma warning disable 0169
			...
			{
				global::MoPub.Volley.VolleyLog.MarkerLog __this = global::Java.Lang.Object.GetObject<global::MoPub.Volley.VolleyLog.MarkerLog> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			public virtual unsafe void Finish (string p0)
			{
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_finish_Ljava_lang_String_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "finish", "(Ljava/lang/String;)V"), __args);
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
			}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (VolleyLog)) {
					SetHandle (
