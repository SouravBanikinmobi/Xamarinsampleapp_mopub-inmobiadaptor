...
namespace MoPub.Volley {
	...
	public partial class NetworkError : global::MoPub.Volley.VolleyError {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (NetworkError)) {
					SetHandle (
		...
		public unsafe NetworkError (global::MoPub.Volley.NetworkResponse p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
