		...
		public virtual unsafe void HandleUrl (global::com.mopub.common.UrlHandler p0, global::Android.Content.Context p1, global::Android.Net.Uri p2, bool p3)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_handleUrl_Lcom_mopub_common_UrlHandler_Landroid_content_Context_Landroid_net_Uri_Z, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "handleUrl", "(Lcom/mopub/common/UrlHandler;Landroid/content/Context;Landroid/net/Uri;Z)V"), __args);
			} finally {
			}
		}
	...
	internal partial class UrlActionInvoker : UrlAction {
		...
		protected override unsafe void PerformAction (global::Android.Content.Context p0, global::Android.Net.Uri p1, global::com.mopub.common.UrlHandler p2)
		{
			...
			try {
				...
				__args [1] = new JValue (p1);
				__args [2] = new JValue (p2);
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_performAction_Landroid_content_Context_Landroid_net_Uri_Lcom_mopub_common_UrlHandler_, __args);
			} finally {
			}
		}
		...
		public override unsafe bool ShouldTryHandlingUrl (global::Android.Net.Uri p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				bool __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_shouldTryHandlingUrl_Landroid_net_Uri_, __args);
				return __ret;
			} finally {
			}
		}
