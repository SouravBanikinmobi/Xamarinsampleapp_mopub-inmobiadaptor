...
namespace MoPub.Volley {
	...
	[Register ("com/mopub/volley/RetryPolicy", "", "MoPub.Volley.IRetryPolicyInvoker")]
	public partial interface IRetryPolicy : IJavaObject {
		...
		int CurrentRetryCount {
			...
			[Register ("getCurrentRetryCount", "()I", "GetGetCurrentRetryCountHandler:MoPub.Volley.IRetryPolicyInvoker, MopubSdk")] get;
		}
		...
		int CurrentTimeout {
			...
			[Register ("getCurrentTimeout", "()I", "GetGetCurrentTimeoutHandler:MoPub.Volley.IRetryPolicyInvoker, MopubSdk")] get;
		}
		...
		[Register ("retry", "(Lcom/mopub/volley/VolleyError;)V", "GetRetry_Lcom_mopub_volley_VolleyError_Handler:MoPub.Volley.IRetryPolicyInvoker, MopubSdk")]
		void Retry (global::MoPub.Volley.VolleyError p0);
