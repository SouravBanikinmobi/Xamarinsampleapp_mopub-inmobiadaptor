...
namespace MoPub.Volley {
	...
	public partial class DefaultRetryPolicy : global::Java.Lang.Object, global::MoPub.Volley.IRetryPolicy {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (DefaultRetryPolicy)) {
					SetHandle (
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getBackoffMultiplier);
					else
						return JNIEnv.CallNonvirtualFloatMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getBackoffMultiplier", "()F"));
				} finally {
				}
			}
		}
		...
		public virtual unsafe int CurrentRetryCount {
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getCurrentRetryCount);
					else
						return JNIEnv.CallNonvirtualIntMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCurrentRetryCount", "()I"));
				} finally {
				}
			}
		}
		...
		public virtual unsafe int CurrentTimeout {
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getCurrentTimeout);
					else
						return JNIEnv.CallNonvirtualIntMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCurrentTimeout", "()I"));
				} finally {
				}
			}
		}
		...
		protected virtual unsafe bool HasAttemptRemaining {
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_hasAttemptRemaining);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "hasAttemptRemaining", "()Z"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void Retry (global::MoPub.Volley.VolleyError p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "retry", "(Lcom/mopub/volley/VolleyError;)V"), __args);
			} finally {
			}
		}
