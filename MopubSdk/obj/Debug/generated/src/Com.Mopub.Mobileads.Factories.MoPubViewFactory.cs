...
namespace Com.Mopub.Mobileads.Factories {
	...
	public partial class MoPubViewFactory : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MoPubViewFactory)) {
					SetHandle (
		...
		protected virtual unsafe global::com.mopub.mobileads.MoPubView InternalCreate (global::Android.Content.Context p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.MoPubView> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_internalCreate_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.MoPubView> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "internalCreate", "(Landroid/content/Context;)Lcom/mopub/mobileads/MoPubView;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
