...
namespace Com.Mopub.Mobileads.Factories {
	...
	public partial class CustomEventInterstitialFactory : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CustomEventInterstitialFactory)) {
					SetHandle (
		...
		protected virtual unsafe global::com.mopub.mobileads.CustomEventInterstitial InternalCreate (string p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.CustomEventInterstitial> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_internalCreate_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.CustomEventInterstitial> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "internalCreate", "(Ljava/lang/String;)Lcom/mopub/mobileads/CustomEventInterstitial;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
