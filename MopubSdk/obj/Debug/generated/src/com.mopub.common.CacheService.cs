...
namespace com.mopub.common {
	...
	public partial class CacheService : global::Java.Lang.Object {
		...
		public partial interface IDiskLruCacheGetListener : IJavaObject {
			...
			[Register ("onComplete", "(Ljava/lang/String;[B)V", "GetOnComplete_Ljava_lang_String_arrayBHandler:com.mopub.common.CacheService/IDiskLruCacheGetListenerInvoker, MopubSdk")]
...
#pragma warning restore 0169
			...
			public unsafe void OnComplete (string p0, byte[] p1)
			{
				...
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onComplete_Ljava_lang_String_arrayB, __args);
		...
		// event args for com.mopub.common.CacheService.DiskLruCacheGetListener.onComplete
...
#pragma warning restore 0169
			...
			protected virtual unsafe byte[] DoInBackground (params global::Java.Lang.Void[] p0)
			{
				...
				try {
					...
					byte[] __ret;
					if (((object) this).GetType () == ThresholdType)
						__ret = (byte[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_doInBackground_arrayLjava_lang_Void_, __args), JniHandleOwnership.TransferLocalRef, typeof (byte));
					else
						__ret = (byte[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "doInBackground", "([Ljava/lang/Void;)[B"), __args), JniHandleOwnership.TransferLocalRef, typeof (byte));
					return __ret;
				} finally {
					if (p0 != null) {
						JNIEnv.CopyArray (native_p0, p0);
...
#pragma warning restore 0169
			...
			protected virtual unsafe void OnPostExecute (byte[] p0)
			{
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onPostExecute_arrayB, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onPostExecute", "([B)V"), __args);
				} finally {
					if (p0 != null) {
						JNIEnv.CopyArray (native_p0, p0);
						JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CacheService)) {
					SetHandle (
