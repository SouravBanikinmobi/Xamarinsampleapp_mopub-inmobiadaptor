...
namespace Com.Squareup.Picasso {
	...
	public abstract partial class RequestHandler : global::Java.Lang.Object {
		...
		public sealed partial class Result : global::Java.Lang.Object {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (((object) this).GetType () != typeof (Result)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/io/InputStream;Lcom/squareup/picasso/Picasso$LoadedFrom;)V", __args),
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (((object) this).GetType () != typeof (Result)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Landroid/graphics/Bitmap;Lcom/squareup/picasso/Picasso$LoadedFrom;)V", __args),
								JniHandleOwnership.TransferLocalRef);
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (RequestHandler)) {
					SetHandle (
