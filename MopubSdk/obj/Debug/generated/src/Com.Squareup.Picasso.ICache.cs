...
namespace Com.Squareup.Picasso {
	...
	public abstract class Cache : Java.Lang.Object {
		...
		new static IntPtr class_ref = JNIEnv.FindClass ("com/squareup/picasso/Cache");
	}
	...
	public partial interface ICache : IJavaObject {
		...
		[Register ("clear", "()V", "GetClearHandler:Com.Squareup.Picasso.ICacheInvoker, MopubSdk")]
		void Clear ();
		...
		[Register ("clearKeyUri", "(Ljava/lang/String;)V", "GetClearKeyUri_Ljava_lang_String_Handler:Com.Squareup.Picasso.ICacheInvoker, MopubSdk")]
		...
		[Register ("get", "(Ljava/lang/String;)Landroid/graphics/Bitmap;", "GetGet_Ljava_lang_String_Handler:Com.Squareup.Picasso.ICacheInvoker, MopubSdk")]
		...
		[Register ("maxSize", "()I", "GetMaxSizeHandler:Com.Squareup.Picasso.ICacheInvoker, MopubSdk")]
		int MaxSize ();
		...
		[Register ("set", "(Ljava/lang/String;Landroid/graphics/Bitmap;)V", "GetSet_Ljava_lang_String_Landroid_graphics_Bitmap_Handler:Com.Squareup.Picasso.ICacheInvoker, MopubSdk")]
		...
		[Register ("size", "()I", "GetSizeHandler:Com.Squareup.Picasso.ICacheInvoker, MopubSdk")]
		int Size ();
