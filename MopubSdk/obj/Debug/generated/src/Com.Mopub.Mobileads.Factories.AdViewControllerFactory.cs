...
namespace Com.Mopub.Mobileads.Factories {
	...
	public partial class AdViewControllerFactory : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (AdViewControllerFactory)) {
					SetHandle (
		...
		protected virtual unsafe global::com.mopub.mobileads.AdViewController InternalCreate (global::Android.Content.Context p0, global::com.mopub.mobileads.MoPubView p1)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.AdViewController> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_internalCreate_Landroid_content_Context_Lcom_mopub_mobileads_MoPubView_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.AdViewController> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "internalCreate", "(Landroid/content/Context;Lcom/mopub/mobileads/MoPubView;)Lcom/mopub/mobileads/AdViewController;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
