...
namespace com.mopub.common {
	...
	public partial class CloseableLayout : global::Android.Widget.FrameLayout {
		...
		public partial interface IOnCloseListener : IJavaObject {
			...
			[Register ("onClose", "()V", "GetOnCloseHandler:com.mopub.common.CloseableLayout/IOnCloseListenerInvoker, MopubSdk")]
			void OnClose ();
...
#pragma warning restore 0649
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CloseableLayout)) {
					SetHandle (
		...
		public virtual unsafe bool CloseVisible {
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isCloseVisible);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isCloseVisible", "()Z"));
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setCloseVisible_Z, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setCloseVisible", "(Z)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void ApplyCloseRegionBounds (global::com.mopub.common.CloseableLayout.ClosePosition p0, global::Android.Graphics.Rect p1, global::Android.Graphics.Rect p2)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_applyCloseRegionBounds_Lcom_mopub_common_CloseableLayout_ClosePosition_Landroid_graphics_Rect_Landroid_graphics_Rect_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "applyCloseRegionBounds", "(Lcom/mopub/common/CloseableLayout$ClosePosition;Landroid/graphics/Rect;Landroid/graphics/Rect;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetClosePosition (global::com.mopub.common.CloseableLayout.ClosePosition p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setClosePosition_Lcom_mopub_common_CloseableLayout_ClosePosition_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setClosePosition", "(Lcom/mopub/common/CloseableLayout$ClosePosition;)V"), __args);
			} finally {
			}
		}
