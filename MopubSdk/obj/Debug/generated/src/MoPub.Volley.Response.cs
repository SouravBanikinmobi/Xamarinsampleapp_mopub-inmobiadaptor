...
namespace MoPub.Volley {
	...
	public partial class Response : global::Java.Lang.Object {
		...
		[Register ("cacheEntry")]
		public global::MoPub.Volley.CacheEntry CacheEntry {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, cacheEntry_jfieldId);
				return global::Java.Lang.Object.GetObject<global::MoPub.Volley.CacheEntry> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (cacheEntry_jfieldId == IntPtr.Zero)
					cacheEntry_jfieldId = JNIEnv.GetFieldID (class_ref, "cacheEntry", "Lcom/mopub/volley/Cache$Entry;");
				...
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, cacheEntry_jfieldId, native_value);
				} finally {
		...
		public bool Intermediate {
			get {
				...
				return JNIEnv.GetBooleanField (((global::Java.Lang.Object) this).Handle, intermediate_jfieldId);
			}
			set {
				if (intermediate_jfieldId == IntPtr.Zero)
					intermediate_jfieldId = JNIEnv.GetFieldID (class_ref, "intermediate", "Z");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, intermediate_jfieldId, value);
				} finally {
				}
			}
		}
		...
		[Register ("com/mopub/volley/Response$ErrorListener", "", "MoPub.Volley.Response/IErrorListenerInvoker")]
		public partial interface IErrorListener : IJavaObject {
			...
			[Register ("onErrorResponse", "(Lcom/mopub/volley/VolleyError;)V", "GetOnErrorResponse_Lcom_mopub_volley_VolleyError_Handler:MoPub.Volley.Response/IErrorListenerInvoker, MopubSdk")]
			void OnErrorResponse (global::MoPub.Volley.VolleyError p0);
...
#pragma warning restore 0169
			...
			public unsafe void OnErrorResponse (global::MoPub.Volley.VolleyError p0)
			{
		...
		// event args for com.mopub.volley.Response.ErrorListener.onErrorResponse
		public partial class ErrorEventArgs : global::System.EventArgs {
			...
			global::MoPub.Volley.VolleyError p0;
			public global::MoPub.Volley.VolleyError P0 {
				get { return p0; }
			}
		}
...
#pragma warning restore 0649
		...
		[Register ("com/mopub/volley/Response$Listener", "", "MoPub.Volley.Response/IListenerInvoker")]
		[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
		public partial interface IListener : IJavaObject {

			// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.volley']/interface[@name='Response.Listener']/method[@name='onResponse' and count(parameter)=1 and parameter[1][@type='T']]"
			[Register ("onResponse", "(Ljava/lang/Object;)V", "GetOnResponse_Ljava_lang_Object_Handler:MoPub.Volley.Response/IListenerInvoker, MopubSdk")]
...
#pragma warning disable 0169
			...
			{
				global::MoPub.Volley.Response.IListener __this = global::Java.Lang.Object.GetObject<global::MoPub.Volley.Response.IListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			public unsafe void OnResponse (global::Java.Lang.Object p0)
			{
				...
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onResponse_Ljava_lang_Object_, __args);
				JNIEnv.DeleteLocalRef (native_p0);
			}

		}

		// event args for com.mopub.volley.Response.Listener.onResponse
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.volley']/class[@name='Response']/method[@name='success' and count(parameter)=2 and parameter[1][@type='T'] and parameter[2][@type='com.mopub.volley.Cache.Entry']]"
