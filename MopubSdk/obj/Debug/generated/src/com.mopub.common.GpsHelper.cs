		...
		public partial class AdvertisingInfo : global::Java.Lang.Object {
			...
			public string AdvertisingId {
				get {
					...
					IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, advertisingId_jfieldId);
				...
				set {
					...
					try {
						JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, advertisingId_jfieldId, native_value);
					} finally {
			...
			public bool LimitAdTracking {
				get {
					...
					return JNIEnv.GetBooleanField (((global::Java.Lang.Object) this).Handle, limitAdTracking_jfieldId);
				}
				set {
					if (limitAdTracking_jfieldId == IntPtr.Zero)
						limitAdTracking_jfieldId = JNIEnv.GetFieldID (class_ref, "limitAdTracking", "Z");
					try {
						JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, limitAdTracking_jfieldId, value);
					} finally {
					}
				}
			}
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (((object) this).GetType () != typeof (AdvertisingInfo)) {
						SetHandle (
		...
		public partial class FetchAdvertisingInfoTask : global::Android.OS.AsyncTask {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					__args [1] = new JValue (p1);
					if (((object) this).GetType () != typeof (FetchAdvertisingInfoTask)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Landroid/content/Context;Lcom/mopub/common/GpsHelper$GpsHelperListener;)V", __args),
								JniHandleOwnership.TransferLocalRef);
						global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Landroid/content/Context;Lcom/mopub/common/GpsHelper$GpsHelperListener;)V", __args);
						return;
					}
					...
					SetHandle (
							...
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Landroid_content_Context_Lcom_mopub_common_GpsHelper_GpsHelperListener_, __args);
				} finally {
				}
			}
...
#pragma warning restore 0169
		...
		public partial interface IGpsHelperListener : IJavaObject {
			...
			[Register ("onFetchAdInfoCompleted", "()V", "GetOnFetchAdInfoCompletedHandler:com.mopub.common.GpsHelper/IGpsHelperListenerInvoker, MopubSdk")]
...
#pragma warning restore 0169
			...
			public unsafe void OnFetchAdInfoCompleted ()
			{
				...
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onFetchAdInfoCompleted);
			}
...
#pragma warning restore 0649
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (GpsHelper)) {
					SetHandle (
