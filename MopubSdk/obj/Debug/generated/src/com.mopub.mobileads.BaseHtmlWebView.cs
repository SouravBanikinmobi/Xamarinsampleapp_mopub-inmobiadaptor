	...
	public partial class BaseHtmlWebView : global::com.mopub.mobileads.BaseWebView, global::com.mopub.mobileads.ViewGestureDetector.IUserClickListener {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (BaseHtmlWebView)) {
					SetHandle (
		...
		public virtual unsafe void Init (bool p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_init_Z, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "init", "(Z)V"), __args);
			} finally {
			}
		}
		...
		public virtual unsafe void OnResetUserClick ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onResetUserClick", "()V"));
			} finally {
			}
		}
		...
		public virtual unsafe void OnUserClick ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onUserClick", "()V"));
			} finally {
			}
		}
		...
		public virtual unsafe bool WasClicked ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "wasClicked", "()Z"));
			} finally {
			}
		}
