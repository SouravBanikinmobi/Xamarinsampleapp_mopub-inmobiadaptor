...
namespace MoPub.Volley {
	...
	public partial class ExecutorDelivery : global::Java.Lang.Object, global::MoPub.Volley.IResponseDelivery {
...
#pragma warning disable 0169
			...
			{
				global::MoPub.Volley.ExecutorDelivery.ResponseDeliveryRunnable __this = global::Java.Lang.Object.GetObject<global::MoPub.Volley.ExecutorDelivery.ResponseDeliveryRunnable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				__this.Run ();
			}
#pragma warning restore 0169
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ExecutorDelivery)) {
					SetHandle (
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ExecutorDelivery)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/util/concurrent/Executor;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/util/concurrent/Executor;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_util_concurrent_Executor_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void PostResponse (global::MoPub.Volley.Request p0, global::MoPub.Volley.Response p1, global::Java.Lang.IRunnable p2)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "postResponse", "(Lcom/mopub/volley/Request;Lcom/mopub/volley/Response;Ljava/lang/Runnable;)V"), __args);
			} finally {
			}
		}
