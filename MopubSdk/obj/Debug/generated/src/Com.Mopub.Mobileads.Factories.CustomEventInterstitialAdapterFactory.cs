...
namespace Com.Mopub.Mobileads.Factories {
	...
	public partial class CustomEventInterstitialAdapterFactory : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CustomEventInterstitialAdapterFactory)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mobileads.factories']/class[@name='CustomEventInterstitialAdapterFactory']/method[@name='create' and count(parameter)=5 and parameter[1][@type='com.mopub.mobileads.MoPubInterstitial'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;'] and parameter[4][@type='long'] and parameter[5][@type='com.mopub.common.AdReport']]"
		...
		public static unsafe global::com.mopub.mobileads.CustomEventInterstitialAdapter Create (global::com.mopub.mobileads.MoPubInterstitial p0, string p1, global::System.Collections.Generic.IDictionary<string, string> p2, long p3, global::com.mopub.common.AdReport p4)
		{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mobileads.factories']/class[@name='CustomEventInterstitialAdapterFactory']/method[@name='internalCreate' and count(parameter)=5 and parameter[1][@type='com.mopub.mobileads.MoPubInterstitial'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;'] and parameter[4][@type='long'] and parameter[5][@type='com.mopub.common.AdReport']]"
		...
		protected virtual unsafe global::com.mopub.mobileads.CustomEventInterstitialAdapter InternalCreate (global::com.mopub.mobileads.MoPubInterstitial p0, string p1, global::System.Collections.Generic.IDictionary<string, string> p2, long p3, global::com.mopub.common.AdReport p4)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.CustomEventInterstitialAdapter> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_internalCreate_Lcom_mopub_mobileads_MoPubInterstitial_Ljava_lang_String_Ljava_util_Map_JLcom_mopub_common_AdReport_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.CustomEventInterstitialAdapter> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "internalCreate", "(Lcom/mopub/mobileads/MoPubInterstitial;Ljava/lang/String;Ljava/util/Map;JLcom/mopub/common/AdReport;)Lcom/mopub/mobileads/CustomEventInterstitialAdapter;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
				JNIEnv.DeleteLocalRef (native_p2);
