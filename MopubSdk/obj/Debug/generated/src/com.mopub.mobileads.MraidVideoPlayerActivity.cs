...
namespace com.mopub.mobileads {
	...
	public partial class MraidVideoPlayerActivity : global::com.mopub.mobileads.BaseVideoPlayerActivity, global::com.mopub.mobileads.BaseVideoViewController.IBaseVideoViewControllerListener {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MraidVideoPlayerActivity)) {
					SetHandle (
		...
		public virtual unsafe void OnFinish ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onFinish", "()V"));
			} finally {
			}
		}
		...
		public virtual unsafe void OnSetContentView (global::Android.Views.View p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onSetContentView", "(Landroid/view/View;)V"), __args);
			} finally {
			}
		}
		...
		public virtual unsafe void OnSetRequestedOrientation (int p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onSetRequestedOrientation", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mobileads']/class[@name='MraidVideoPlayerActivity']/method[@name='onStartActivityForResult' and count(parameter)=3 and parameter[1][@type='java.lang.Class&lt;? extends android.app.Activity&gt;'] and parameter[2][@type='int'] and parameter[3][@type='android.os.Bundle']]"
		...
		public virtual unsafe void OnStartActivityForResult (global::Java.Lang.Class p0, int p1, global::Android.OS.Bundle p2)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onStartActivityForResult", "(Ljava/lang/Class;ILandroid/os/Bundle;)V"), __args);
			} finally {
			}
		}
