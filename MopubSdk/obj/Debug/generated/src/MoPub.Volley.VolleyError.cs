...
namespace MoPub.Volley {
	...
	public partial class VolleyError : global::Java.Lang.Exception {
		...
		public global::MoPub.Volley.NetworkResponse NetworkResponse {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Throwable) this).Handle, networkResponse_jfieldId);
				return global::Java.Lang.Object.GetObject<global::MoPub.Volley.NetworkResponse> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (networkResponse_jfieldId == IntPtr.Zero)
					networkResponse_jfieldId = JNIEnv.GetFieldID (class_ref, "networkResponse", "Lcom/mopub/volley/NetworkResponse;");
				...
				try {
					JNIEnv.SetField (((global::Java.Lang.Throwable) this).Handle, networkResponse_jfieldId, native_value);
				} finally {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (VolleyError)) {
					SetHandle (
		...
		public unsafe VolleyError (global::MoPub.Volley.NetworkResponse p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallLongMethod (((global::Java.Lang.Throwable) this).Handle, id_getNetworkTimeMs);
					else
						return JNIEnv.CallNonvirtualLongMethod (((global::Java.Lang.Throwable) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getNetworkTimeMs", "()J"));
				} finally {
				}
			}
		}
