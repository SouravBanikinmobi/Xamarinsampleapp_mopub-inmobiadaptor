	...
	public partial class BaseWebView : global::Android.Webkit.WebView {
		...
		protected bool MIsDestroyed {
			get {
				...
				return JNIEnv.GetBooleanField (((global::Java.Lang.Object) this).Handle, mIsDestroyed_jfieldId);
			}
			set {
				if (mIsDestroyed_jfieldId == IntPtr.Zero)
					mIsDestroyed_jfieldId = JNIEnv.GetFieldID (class_ref, "mIsDestroyed", "Z");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, mIsDestroyed_jfieldId, value);
				} finally {
				}
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (BaseWebView)) {
					SetHandle (
		...
		protected virtual unsafe void EnablePlugins (bool p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_enablePlugins_Z, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "enablePlugins", "(Z)V"), __args);
			} finally {
			}
		}
