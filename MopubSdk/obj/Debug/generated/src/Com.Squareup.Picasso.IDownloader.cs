	...
	public partial class DownloaderResponse : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (DownloaderResponse)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Landroid/graphics/Bitmap;ZJ)V", __args),
							JniHandleOwnership.TransferLocalRef);
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (DownloaderResponse)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Landroid/graphics/Bitmap;Z)V", __args),
							JniHandleOwnership.TransferLocalRef);
...
#pragma warning restore 0169
	...
	public partial class DownloaderResponseException : global::Java.IO.IOException {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [1] = new JValue (p1);
				__args [2] = new JValue (p2);
				if (((object) this).GetType () != typeof (DownloaderResponseException)) {
					SetHandle (
	...
	public partial interface IDownloader : IJavaObject {
		...
		[Register ("load", "(Landroid/net/Uri;I)Lcom/squareup/picasso/Downloader$Response;", "GetLoad_Landroid_net_Uri_IHandler:Com.Squareup.Picasso.IDownloaderInvoker, MopubSdk")]
		...
		[Register ("shutdown", "()V", "GetShutdownHandler:Com.Squareup.Picasso.IDownloaderInvoker, MopubSdk")]
		void Shutdown ();
