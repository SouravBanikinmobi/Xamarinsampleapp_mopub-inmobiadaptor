...
namespace MoPub.Volley {
	...
	public partial class ParseError : global::MoPub.Volley.VolleyError {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ParseError)) {
					SetHandle (
		...
		public unsafe ParseError (global::MoPub.Volley.NetworkResponse p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
