...
namespace Com.Squareup.Picasso {
	...
	public partial class CallbackEmptyCallback : global::Java.Lang.Object, global::Com.Squareup.Picasso.ICallback {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CallbackEmptyCallback)) {
					SetHandle (
...
#pragma warning restore 0169
	...
	public partial interface ICallback : IJavaObject {
		...
		[Register ("onError", "()V", "GetOnErrorHandler:Com.Squareup.Picasso.ICallbackInvoker, MopubSdk")]
		void OnError ();
		...
		[Register ("onSuccess", "()V", "GetOnSuccessHandler:Com.Squareup.Picasso.ICallbackInvoker, MopubSdk")]
		void OnSuccess ();
