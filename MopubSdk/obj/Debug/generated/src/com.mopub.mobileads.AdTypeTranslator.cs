...
namespace com.mopub.mobileads {
	...
	public partial class AdTypeTranslator : global::Java.Lang.Object {
		...
		public sealed partial class CustomEventType : global::Java.Lang.Enum {
			...
			static IntPtr MOPUB_VIDEO_NATIVE_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.mopub.mobileads']/class[@name='AdTypeTranslator.CustomEventType']/field[@name='MOPUB_VIDEO_NATIVE']"
			[Register ("MOPUB_VIDEO_NATIVE")]
			public static global::com.mopub.mobileads.AdTypeTranslator.CustomEventType MopubVideoNative {
				get {
					if (MOPUB_VIDEO_NATIVE_jfieldId == IntPtr.Zero)
						MOPUB_VIDEO_NATIVE_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "MOPUB_VIDEO_NATIVE", "Lcom/mopub/mobileads/AdTypeTranslator$CustomEventType;");
					IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, MOPUB_VIDEO_NATIVE_jfieldId);
					return global::Java.Lang.Object.GetObject<global::com.mopub.mobileads.AdTypeTranslator.CustomEventType> (__ret, JniHandleOwnership.TransferLocalRef);
				}
			}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (AdTypeTranslator)) {
					SetHandle (
