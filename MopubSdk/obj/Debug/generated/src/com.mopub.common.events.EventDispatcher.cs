...
#pragma warning restore 0169
		...
		public virtual unsafe void Dispatch (global::com.mopub.common.events.BaseEvent p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_dispatch_Lcom_mopub_common_event_BaseEvent_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "dispatch", "(Lcom/mopub/common/event/BaseEvent;)V"), __args);
			} finally {
			}
		}
