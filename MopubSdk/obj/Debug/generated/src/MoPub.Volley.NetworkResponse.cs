	...
	public partial class NetworkResponse : global::Java.Lang.Object {
		...
		public long NetworkTimeMs {
			get {
				...
				return JNIEnv.GetLongField (((global::Java.Lang.Object) this).Handle, networkTimeMs_jfieldId);
			}
			set {
				if (networkTimeMs_jfieldId == IntPtr.Zero)
					networkTimeMs_jfieldId = JNIEnv.GetFieldID (class_ref, "networkTimeMs", "J");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, networkTimeMs_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public bool NotModified {
			get {
				...
				return JNIEnv.GetBooleanField (((global::Java.Lang.Object) this).Handle, notModified_jfieldId);
			}
			set {
				if (notModified_jfieldId == IntPtr.Zero)
					notModified_jfieldId = JNIEnv.GetFieldID (class_ref, "notModified", "Z");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, notModified_jfieldId, value);
				} finally {
				}
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mopub.volley']/class[@name='NetworkResponse']/constructor[@name='NetworkResponse' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;']]"
		[Register (".ctor", "([BLjava/util/Map;)V", "")]
		public unsafe NetworkResponse (byte[] p0, global::System.Collections.Generic.IDictionary<string, string> p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (NetworkResponse)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mopub.volley']/class[@name='NetworkResponse']/constructor[@name='NetworkResponse' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;'] and parameter[4][@type='boolean']]"
		[Register (".ctor", "(I[BLjava/util/Map;Z)V", "")]
		public unsafe NetworkResponse (int p0, byte[] p1, global::System.Collections.Generic.IDictionary<string, string> p2, bool p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (((object) this).GetType () != typeof (NetworkResponse)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(I[BLjava/util/Map;Z)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(I[BLjava/util/Map;Z)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_IarrayBLjava_util_Map_Z, __args);
			} finally {
				if (p1 != null) {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mopub.volley']/class[@name='NetworkResponse']/constructor[@name='NetworkResponse' and count(parameter)=5 and parameter[1][@type='int'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;'] and parameter[4][@type='boolean'] and parameter[5][@type='long']]"
		[Register (".ctor", "(I[BLjava/util/Map;ZJ)V", "")]
		public unsafe NetworkResponse (int p0, byte[] p1, global::System.Collections.Generic.IDictionary<string, string> p2, bool p3, long p4)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (((object) this).GetType () != typeof (NetworkResponse)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(I[BLjava/util/Map;ZJ)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(I[BLjava/util/Map;ZJ)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_IarrayBLjava_util_Map_ZJ, __args);
			} finally {
				if (p1 != null) {
					JNIEnv.CopyArray (native_p1, p1);
					JNIEnv.DeleteLocalRef (native_p1);
