...
namespace com.mopub.mobileads {
	...
	public partial class CustomEventBannerAdapter : global::Java.Lang.Object, global::com.mopub.mobileads.CustomEventBanner.ICustomEventBannerListener {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mopub.mobileads']/class[@name='CustomEventBannerAdapter']/constructor[@name='CustomEventBannerAdapter' and count(parameter)=5 and parameter[1][@type='com.mopub.mobileads.MoPubView'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;'] and parameter[4][@type='long'] and parameter[5][@type='com.mopub.common.AdReport']]"
		...
		public virtual unsafe void OnBannerCollapsed ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onBannerCollapsed", "()V"));
			} finally {
			}
		}
		...
		public virtual unsafe void OnBannerExpanded ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onBannerExpanded", "()V"));
			} finally {
			}
		}
		...
		public virtual unsafe void OnBannerFailed (global::com.mopub.mobileads.MoPubErrorCode p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onBannerFailed", "(Lcom/mopub/mobileads/MoPubErrorCode;)V"), __args);
			} finally {
			}
		}
		...
		public virtual unsafe void OnBannerLoaded (global::Android.Views.View p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onBannerLoaded", "(Landroid/view/View;)V"), __args);
			} finally {
			}
		}
