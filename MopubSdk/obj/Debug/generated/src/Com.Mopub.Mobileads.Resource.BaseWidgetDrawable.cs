...
namespace Com.Mopub.Mobileads.Resource {
	...
	public abstract partial class BaseWidgetDrawable : global::Android.Graphics.Drawables.Drawable {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (BaseWidgetDrawable)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		protected virtual unsafe void DrawTextWithinBounds (global::Android.Graphics.Canvas p0, global::Android.Graphics.Paint p1, global::Android.Graphics.Rect p2, string p3)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_drawTextWithinBounds_Landroid_graphics_Canvas_Landroid_graphics_Paint_Landroid_graphics_Rect_Ljava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "drawTextWithinBounds", "(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Rect;Ljava/lang/String;)V"), __args);
			} finally {
